...
REMOTE_SAVE_DIR=$ZHIYUHE/250916_ruler/flexprefill_mix_per_layer_nlast512/
...
for MAX_SEQ_LENGTH in "${SEQ_LENGTHS[@]}"; do
    ...
    for TASK in "${TASKS[@]}"; do
        ...
        python ${RULER_PATH}/pred/call_api.py \
            ...
            --attn_kwargs "{\"tri_layer_idx_list\": $tri_layer_idx_list_str, \"gamma\": 0.95, \"n_local\": 512, \"n_init\": 8, \"last_n\": 512}" \
